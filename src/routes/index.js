...
import HelpSupport from '../pages/profile/Help';
import AddPlan from '../pages/apps/Email/Inbox';
import ListofPlan from '../pages/apps/Email/Detail';
import AddSubAdmin from '../pages/apps/Project/List';
import ListSubAdmin from '../pages/apps/Project/ListSubAdmin';
import Profile from '../pages/apps/Tasks/List';
import ChangePassword from '../pages/apps/Tasks/Board';
...
const appRoutes = [ tableRoutes, emailAppRoutes, projectAppRoutes, taskAppRoutes, helpSupport];
